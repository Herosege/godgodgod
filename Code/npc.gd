...
Also if you kill these floating things you will regain a jump",
	...
	"henryk":"HI YOU FREAKY LITTLE THING, MY NAME IS HENRYK
	...
	IF YOU FIND SOMETHING LIKE THAT, COME BY HERE
	AND GET RID OF THIS
	
	BE QUICK I HAVE SOME IMPORTANT BUISNESS TO ATTEND TO
	AND THERE IS SOME CANCEROUS STUFF GROWING NEAR
